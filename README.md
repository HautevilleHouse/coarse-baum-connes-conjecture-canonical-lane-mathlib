# Coarse Baum Connes Conjecture — Canonical Lane Mathlib
...
```bash
git clone https://github.com/HautevilleHouse/coarse-baum-connes-conjecture-canonical-lane-mathlib.git
cd coarse-baum-connes-conjecture-canonical-lane-mathlib
lake exe
lake build
```
